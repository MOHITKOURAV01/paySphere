...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    payrollConfig: {
      currency: 'INR (₹)',
      leaveDeductionPolicy: 'basic_only',
      processingDate: 'Last working day',
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={userProfile.payrollId || 'PR-8821'}
                  readOnly
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue="Admin"
                  className="w-full px-4 py-3 rounded-xl bg-gray-100 dark:bg-slate-900 border border-transparent dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 outline-none text-sm text-gray-900 dark:text-white transition"
                />
              </div>
            </div>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="p-5 border border-red-200 dark:border-red-900/30 rounded-2xl bg-red-50/50 dark:bg-red-950/10 shadow-sm">
              <h3 className="font-bold text-sm text-red-600 dark:text-red-400 mb-2">
                Danger Zone
              </h3>
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-red-600 text-white rounded-lg text-sm font-bold transition hover:bg-red-700"
                >
                  Delete Account
                </button>
              </div>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-slate-500 mt-1">
                Customize your UI and language settings.
              </p>
            </div>
              ...
              <div className="p-5 border border-gray-100 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 shadow-sm">
                ...
                <div className="space-y-3">
                  {['light', 'dark', 'system'].map((t) => (
                    <label
                      key={t}
                      className="flex items-center gap-3 cursor-pointer p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 transition border border-transparent"
                    >
                      <input
                        type="radio"
                        name="theme"
                        checked={settings.preferences.theme === t}
                        onChange={() => {
                ...
                <p className="text-xs text-gray-500 dark:text-slate-500 mt-3">
                  * Uses standard global theme logic
                </p>
              </div>
              <div className="p-5 border border-gray-100 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 shadow-sm">
                <h3 className="font-bold text-sm text-gray-900 dark:text-white mb-4">
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-slate-500 mt-1">
                Details about your organization registered on PaySphere.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gray-100 dark:bg-slate-900 border border-transparent dark:border-slate-800 outline-none text-sm text-gray-900 dark:text-white transition"
                />
              </div>
              <div>
                <label className="text-xs font-bold uppercase text-gray-500 dark:text-slate-500 tracking-wider mb-2 block">
                  Company Logo (for PDF Payslips)
                </label>
                <input
                  type="file"
                  accept="image/*"
                ...
                {settings.companyInfo?.companyLogo && (
                  <img
                    src={settings.companyInfo.companyLogo}
                    alt="Company Logo"
                    className="mt-2 h-10 w-10 object-contain rounded-md"
                  />
                )}
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={userProfile.organizationId || 'ORG-993821'}
                  readOnly
                  className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-slate-900/50 border border-transparent dark:border-slate-800 text-sm text-gray-500 dark:text-slate-500 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                />
              </div>
              ...
              <div>
                ...
                <select
                  value={settings.companyInfo.payrollCycle}
                  onChange={(e) =>
                    updateSettingsField(
                      'companyInfo',
                      'payrollCycle',
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gray-100 dark:bg-slate-900 border border-transparent dark:border-slate-800 outline-none text-sm text-gray-900 dark:text-white transition cursor-pointer"
                >
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-slate-500 mt-1">
                Configure default rates, currency, and logic for payroll
                processing.
              </p>
            </div>
            ...
            <div className="p-6 border border-gray-100 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 shadow-sm space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <select
                    value={settings.payrollConfig.currency}
                    onChange={(e) =>
                      updateSettingsField(
                        'payrollConfig',
                        'currency',
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 outline-none text-sm text-gray-900 dark:text-white font-semibold transition cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <select
                    value={settings.payrollConfig.processingDate}
                    onChange={(e) =>
                      updateSettingsField(
                        'payrollConfig',
                        'processingDate',
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="number"
                      value={settings.payrollConfig.defaultDailyRate}
                      onChange={(e) =>
                        updateSettingsField(
                          'payrollConfig',
                          'defaultDailyRate',
                      ...
                      className="w-full pl-8 pr-4 py-3 rounded-xl bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 outline-none text-sm text-gray-900 dark:text-white font-semibold transition"
                    />
                  </div>
                </div>
                <div>
                  <label className="text-xs font-bold uppercase text-gray-500 dark:text-slate-500 tracking-wider mb-2 block">
                    Default Overtime Rate (per hr)
                  </label>
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-slate-500 font-bold text-sm">
                      ₹
                    ...
                    <input
                      type="number"
                      value={settings.payrollConfig.defaultOvertimeRate}
                      onChange={(e) =>
                        updateSettingsField(
                          'payrollConfig',
                          'defaultOvertimeRate',
                ...
                <div>
                  ...
                  <select
                    value={settings.payrollConfig.leaveDeductionPolicy}
                    onChange={(e) =>
                      updateSettingsField(
                        'payrollConfig',
            ...
            <div className="border border-gray-100 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden divide-y divide-gray-100 dark:divide-slate-800">
              ...
              <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-slate-800/50 transition">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-500 mt-1">
                    Alerts for new employee additions or removals.
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
              ...
              <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-slate-800/50 transition">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-500 mt-1">
                    Reminders when a cycle is nearing its processing date.
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
              ...
              <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-slate-800/50 transition">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-500 mt-1">
                    News on new PaySphere features and product updates.
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-slate-500 mt-1">
                System info, documentation, and support.
              </p>
            </div>
            ...
            <div className="border border-gray-100 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden p-6 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-left border-t border-gray-100 dark:border-slate-800 pt-6">
                <div>
                  <p className="text-xs font-bold uppercase text-gray-500 dark:text-slate-500 mb-1">
                    Version
                  </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                <h4 className="font-bold text-sm text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400">
                  Documentation
                </h4>
                <p className="text-xs text-gray-500 dark:text-slate-500 mt-1">
      ...
      >
        <div className="p-5 border-b border-gray-200 dark:border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-slate-500">
                Payroll ID:{' '}
                {userProfile.payrollId
                  ? userProfile.payrollId.replace('PR-', '')
                  : '8821'}
              </p>
            </div>
          </div>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-slate-800 space-y-2">
          ...
          <button
            ...
            className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-md shadow-blue-200 dark:shadow-none transition"
          >
            Run Payroll
          </button>
        </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-red-100 dark:border-red-900/30 w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6">
              ...
              <p className="text-sm text-center text-gray-500 dark:text-slate-500 mb-6">
                ...
                account, your company's payroll data, and all employee records.
              </p>

              <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-gray-500 dark:text-slate-500 tracking-wider">
                  Type{' '}
                  <span className="text-red-600 dark:text-red-500 select-all">
                    DELETE
                  </span>{' '}
                  to confirm
                </label>
